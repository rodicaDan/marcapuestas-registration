...
public class WebDriverProperties {
    ...
    private static final String FIREFOX_PATH = BIN_ROOT.concat("firefoxdriver/geckodriver.exe");
    private static final String IE_PATH = BIN_ROOT.concat("iedriver/IEDriverServer.exe");
    ...
    private static final String FF_BINARY_PROP_SYS_PROP_NAME = "webdriver.gecko.driver";
    ...
    public void setFFBinaryProperty() {

        System.setProperty(FF_BINARY_PROP_SYS_PROP_NAME, FIREFOX_PATH);
